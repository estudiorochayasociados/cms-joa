...
$template->set("description", "Enterate de las últimas novedades en nuestro blog para los especialistas en pinturas");
$template->set("keywords", "blog de pintura, novedades de pinturas para paredes, pinturereria blog,blog para el pintor");
